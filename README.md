...
The file ResultsForPaper.jl uses functions in the file AnalysisFunctions.jl and the solutions generated by mainAll.jl to produce all the model results reported in Section 3 of the paper.
